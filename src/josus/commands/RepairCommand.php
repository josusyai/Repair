...
class RepairCommand extends Command {
    ...
    public function __construct() {
        parent::__construct("fix", "Repara tu inventario o el item de tu hotbar.", null, ["repair"]);
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args)
    {
        if ($sender instanceof Player) {
            $file = Repair::getConfiguration("messages.yml");
            if ($sender->hasPermission("fix-all.command.use") or $sender->hasPermission("fix-all-others.command.use")) {
                ...
                switch ($args[0]){
                    ...
                    case "all":
                        ...
                        if ($sender->hasPermission("fix-all-others.command.use")){
                            $player = Repair::getInstance()->getServer()->getPlayerByPrefix($args[1]);
                            if (is_null($player)){
